...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  ekf_.x_ << 0.0, 0.0, 0.0, 0.0;
      ...
      cout << "ok " << ekf_.x_.size() << ekf_.x_ << endl;
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      Initialize state.
      */
        cout << "lidar init " << endl << "raw measurments=" << measurement_pack.raw_measurements_ <<endl;

        ekf_.x_(0) = measurement_pack.raw_measurements_(0);
        ekf_.x_(1) = measurement_pack.raw_measurements_(1);
        
        cout << "Lidar initialization finished " << endl;
   ...
   */
    ...
    cout << "Modifying F matrix, F size is " << ekf_.F_.size() << endl;
    //Modify the F matrix so that the time is integrated
    ekf_.F_(0, 2) = dt;
    ekf_.F_(1, 3) = dt;
    
    cout << "Finished with F matrix" << endl;
    
    cout << "Modifying Q matrix" << endl;
    ...
    cout << "Finished with Q matrix" << endl;
